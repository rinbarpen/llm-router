...
export type ProviderType = 'openai' | 'gemini' | 'claude' | 'codex_cli' | 'claude_code_cli' | 'openrouter' | 'bigmodel' | 'z.ai' | 'kimi' | 'qwen' | 'grok' | 'groq' | 'deepseek' | 'siliconflow' | 'aihubmix' | 'volcengine' | 'ollama' | 'remote_http' | 'transformers_local' | 'vllm_local' | 'ollama_local'
